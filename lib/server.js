...
var { targetRootHandler, targetWithIdHandler } = require('./routes/targetHandlers');
...
router.set('/api/targets', targetRootHandler);
router.set('/api/targets/:id', targetWithIdHandler);
